...
if input_file:
    ...
    with Popen(['/opt/nustar/bin/ROBIN%d'%DEFAULT_ROBIN_VERSION,'-i',input_file,'-lib',lib,'-omp',omp],stderr=PIPE,stdout=log_file.fileno(),universal_newlines=True) as proc:
